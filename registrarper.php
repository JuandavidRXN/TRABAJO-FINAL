                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="index1.php">FONDA<span class="sr-only">(current)</span></a>
                                </li>
            </header>
            <main class="fondo"> 
    <?php
                    ...
                    <div class="col mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                        ...
                                        <a href="eliminarp.php?id=<?php echo($usario["codigousuario"])?>" class="btn btn-warning">ELIMINAR</a>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editar<?php echo($usario["codigousuario"])?>" name="botonu">
                                         EDITAR
                                     </button>
                                </div>     
                            </div>
                                                ...
                                                <div class="modal-body">
                                                        <form action="edicion.php?id=<?php echo($usario["codigousuario"])?>" method="POST">
                                                            <div class="form-group">
                                                                <label>Nombre:</label>
                                                                <input type="text" class="form-control" value="<?php echo($usario["nombre"])?>"name="nombreu">  
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Descripcion:</label>
                                                                <textarea class="form-control" rows="3" name="descripcionu"> <?php echo($usario["descripcionu"])?></textarea>  
                                                            </div>
                                                            <button type="submit" class="btn btn-primary" name="botonu">enviar</button>
                                                        </form>
                                                </div>
